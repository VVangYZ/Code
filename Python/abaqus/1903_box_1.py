...
# 文件名参数
if angle1 == angle2:
	model_name = 'ssb_' + str(angle1)
	job_name = 'ssb_' + str(angle1) + '_out'
	res_out = './cae/ssb_' + str(angle1) + '_res.json'
	rec_out = './cae/ssb_' + str(angle1) + '_rec.json'
else:
	model_name = 'ssb_r_' + str(angle1)
	job_name = 'ssb_r_' + str(angle1) + '_out'
	res_out = './cae/ssb_r_' + str(angle1) + '_res.json'
	rec_out = './cae/ssb_r_' + str(angle1) + '_rec.json'
...
region = (i_beam.cells, )
box_1.Gravity(name='G', createStepName='beamLoad', comp2=-9.8, region = region)
...
res_1 = get_path(-7, 0, 0, variable1, 1)
